...
include $(PGXS)
override CPPFLAGS := -I. -I${top_srcdir}/src/pl/plpython -I/home/anthony/Documents/work/postgresql/src/backend/utils/ -I/home/anthony/Documents/work/postgresql/src/include/utils/ -I/home/anthony/Documents/work/postgresql/contrib/hstore/ -I/home/anthony/Documents/work/postgresql/src/pl/plpython/ $(python_includespec) $(CPPFLAGS) -DPLPYTHON_LIBNAME='"plpython$(python_majorversion)"'
else
